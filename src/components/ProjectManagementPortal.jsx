...
const ProjectManagementPortal = ({ currentUser }) => {
    ...
    useEffect(() => {
        loadData();
    }, [activeTab, selectedProject, currentUser]);
        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#0f172a', fontFamily: "'Outfit', sans-serif" }}>
            ...
            <div style={{
                ...
                <div style={{ marginBottom: '30px', textAlign: 'center' }}>
                    ...
                    <h3 style={{ color: '#fff', margin: 0 }}>{currentUser?.name || 'Project Lead'}</h3>
                    <p style={{ color: '#94a3b8', fontSize: '0.9rem', margin: 0 }}>{currentUser?.designation || 'Head of Delivery'}</p>
                </div>
